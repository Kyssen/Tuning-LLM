...
def format_question(question, choices):
    # Simple format without instruction tuning structure
...
def main():
    ...
    # Open results file
    with open('story_model_results.txt', 'w', encoding='utf-8') as f:
        f.write("Story Model Evaluation Results (No Context, 10% sample)\n")
        f.write("===============================================\n\n")
    ...
    print("\nEvaluation complete! Results have been saved to 'story_model_results.txt'")
